# Security Group que solo permite Ping (ICMP)
resource "aws_security_group" "ping_only" {
  ...
  # Regla de entrada para ICMP (Ping) - Echo Request
  ingress {
  ...
  # Regla de salida para respuestas ICMP
  egress {
...
# Security Group que solo permite SSH
resource "aws_security_group" "ssh_only" {
  ...
  # Regla de salida para respuestas
  egress {
